...
numbers_list = [int(num) for num in input_numbers.split()]  # Convert input to list
numbers_tuple = tuple(numbers_list)  # Convert list to tuple

# Manipulate List
numbers_list.append(10)  # Append 10 to the list
numbers_list.insert(2, 20)  # Insert 20 at index 2
numbers_list.remove(8)  # Remove one occurrence of 8 from the list
...
try:
    numbers_tuple.insert(2, 20)  # Attempt to insert 20 at index 2 in the tuple
except AttributeError:
    pass  # Insert operation will also raise an error
try:
    numbers_tuple.remove(8)  # Attempt to remove 8 from the tuple
except AttributeError:
